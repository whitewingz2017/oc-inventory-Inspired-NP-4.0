...
export const SecondaryInventory = () => {
    ...
    const [Icons, setIcons] = createStore<any>({
        ...
        'Player': <svg style={{ "margin-top": '-0.3vh' }} stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" height="2.5vh" width="2.2vh" xmlns="http://www.w3.org/2000/svg"> <path fill="none" d="M0 0h24v24H0z"/><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-7 3c1.93 0 3.5 1.57 3.5 3.5S13.93 13 12 13s-3.5-1.57-3.5-3.5S10.07 6 12 6zm7 13H5v-.23c0-.62.28-1.2.76-1.58C7.47 15.82 9.64 15 12 15s4.53.82 6.24 2.19c.48.38.76.97.76 1.58V19z"/></svg>,
        'Backpack': <svg style={{ "margin-top": '-0.3vh' }} stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" height="2.5vh" width="2.2vh" xmlns="http://www.w3.org/2000/svg"> <path fill="none" d="M0 0h24v24H0z"></path><path d="M20 8v12c0 1.1-.9 2-2 2H6c-1.1 0-2-.9-2-2V8c0-1.86 1.28-3.41 3-3.86V2h3v2h4V2h3v2.14c1.72.45 3 2 3 3.86zM6 12v2h10v2h2v-4H6z"></path> </svg>,
        'Body': <svg style={{ "margin-top": '-0.3vh' }} stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" height="2.5vh" width="2.2vh" xmlns="http://www.w3.org/2000/svg"> <path fill="none" d="M0 0h24v24H0z"></path><path d="M20 8v12c0 1.1-.9 2-2 2H6c-1.1 0-2-.9-2-2V8c0-1.86 1.28-3.41 3-3.86V2h3v2h4V2h3v2.14c1.72.45 3 2 3 3.86zM6 12v2h10v2h2v-4H6z"></path> </svg>,
    })
    console.log("SECONDARY SHIT",JSON.stringify(Inventory))
    ...
    return (
        <> {console.log("LENGTH OF PRIMARY THIRD",Object.keys(Inventory.PrimaryThirdInventory).length)}
            <div
                id="secondary"
            ...
            >
                <div>
                    <div>
                        ...
                        <div
                            ...
                            style={{'max-height': Inventory.PrimarySecondaryInventory.slots.length > 15 ? '20.5rem' : ''}}
                            onMouseEnter={() => {
                        ...
                        >
                            <div
                                ...
                                style={`grid-template-columns: repeat(5, minmax(0px, 1fr)); grid-template-rows: repeat(${Inventory.PrimarySecondaryInventory.inventoryLabel === 'Glovebox' || Inventory.PrimarySecondaryInventory.inventoryLabel === 'Player' ? '1': '5'}, minmax(0px, 1fr));`}
                            >
                                <For
                ...
                <Show
                    when={isObjectNonEmpty(Inventory.PrimaryThirdInventory)}
                >
                <div>
                    <div>
                        <div
                            ...
                            >
                                ...
                                >
                                    ...
                                    <span
                                        class="material-symbols-rounded absolute left-[1.75rem] top-[1.75rem] text-[1.5rem] [text-shadow:0px_0px_12px_rgba(0,_248,_185,_0.25)]"
                                    >
                                        {Icons[Inventory.PrimaryThirdInventory.inventoryLabel]}
                                    </span>
                                </div>
                                <div
                                    class="flex w-1/2 flex-col place-content-center pl-20 pt-1"
                                >
                                    <div
                                        class="text-xl font-semibold [text-shadow:0px_0px_5px_rgba(0,_248,_185,_0.05)]"
                                    >
                                        {Inventory.PrimaryThirdInventory.inventoryLabel}
                                    </div>

                                    <div
                                        class="text-[0.88rem] leading-[108.5%] text-gray-300"
                                    >
                                        {Inventory.PrimaryThirdInventory.Weight.toFixed(1)}kg / {Inventory.PrimaryThirdInventory.maxWeight}kg
                                    </div>
                                </div>
                        ...
                        <div
                            ...
                            style={{'max-height': Inventory.PrimaryThirdInventory.slots.length > 15 ? '20.5rem' : ''}}
                            onMouseEnter={() => {
                                setActiveInventory(Inventory.PrimaryThirdInventory.inventoryName)
                            }}
                        >
                            <div
                                class="inline-grid justify-items-center overflow-x-hidden"
                                style={`grid-template-columns: repeat(5, minmax(0px, 1fr)); grid-template-rows: repeat(${Inventory.PrimaryThirdInventory.inventoryLabel === 'Glovebox' ? '1': '5'}, minmax(0px, 1fr));`}
                            >
                                <For
                                    each={Inventory.PrimaryThirdInventory.slots}
                                >
                                    {(pSlot: any) => (
                                        <CreateSlot {...pSlot} />
                                    )}
                ...
                <Show
                    when={isObjectNonEmpty(Inventory.PrimaryFourthInventory)}
                >
                <div>
                    <div>
                        <div
                            ...
                            >
                                ...
                                >
                                    ...
                                    <span
                                        class="material-symbols-rounded absolute left-[1.75rem] top-[1.75rem] text-[1.5rem] [text-shadow:0px_0px_12px_rgba(0,_248,_185,_0.25)]"
                                    >
                                        {Icons[Inventory.PrimaryFourthInventory.inventoryLabel]}
                                    </span>
                                </div>
                                <div
                                    class="flex w-1/2 flex-col place-content-center pl-20 pt-1"
                                >
                                    <div
                                        class="text-xl font-semibold [text-shadow:0px_0px_5px_rgba(0,_248,_185,_0.05)]"
                                    >
                                        {Inventory.PrimaryFourthInventory.inventoryLabel}
                                    </div>

                                    <div
                                        class="text-[0.88rem] leading-[108.5%] text-gray-300"
                                    >
                                        {Inventory.PrimaryFourthInventory.Weight.toFixed(1)}kg / {Inventory.PrimaryFourthInventory.maxWeight}kg
                                    </div>
                                </div>
                        ...
                        <div
                            class="overflow-y-auto [scrollbar-gutter:stable]"
                            style={{'max-height': Inventory.PrimaryFourthInventory.slots.length > 15 ? '20.5rem' : ''}}
                            onMouseEnter={() => {
                                setActiveInventory(Inventory.PrimaryFourthInventory.inventoryName)
                            }}
                        >
                            <div
                                class="inline-grid justify-items-center overflow-x-hidden"
                                style={`grid-template-columns: repeat(5, minmax(0px, 1fr)); grid-template-rows: repeat(${Inventory.PrimaryFourthInventory.inventoryLabel === 'Glovebox' || Inventory.PrimaryFourthInventory.inventoryLabel === 'Body' ? '1': '5'}, minmax(0px, 1fr));`}
                            >
                                <For
                                    each={Inventory.PrimaryFourthInventory.slots}
                                >
                                    {(pSlot: any) => (
                                        <CreateSlot {...pSlot} />
                                    )}
